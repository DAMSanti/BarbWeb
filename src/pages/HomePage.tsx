...
export default function HomePage() {
  ...
  return (
    <div className="w-full">
      ...
      <section id="features" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-dark-500 mb-4">
              ¿Por qué elegirnos?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="p-8 rounded-xl bg-gradient-to-br from-dark-500 to-dark-600 hover:from-dark-600 hover:to-dark-700 border border-primary-600 hover:border-primary-500 hover:shadow-2xl transition-all card-hover"
                >
                  <div className="w-12 h-12 bg-primary-500 rounded-lg flex items-center justify-center mb-4">
                    <Icon className="text-dark-500" size={24} />
                  </div>
      ...
      {/* Services Section */}
      <section className="py-20 lg:py-28 bg-gradient-to-br from-dark-500 via-dark-600 to-dark-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white p-8 rounded-xl border-2 border-primary-500 hover:border-primary-400 hover:shadow-2xl hover:shadow-primary-500/30 transition-all"
              >
                <h3 className="text-xl font-bold text-dark-500 mb-2">{service.name}</h3>
      ...
      <section id="contacto" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-dark-500 mb-6">
